...
from handlers import start,get_language,one_course,two_course,uz_course_handler,ru_course_handler,tree_course,four_course,one_course_ru,two_course_ru,tree_course_ru,four_course_ru,days_uz,days_ru,back_direction ,send_lesson
...
def main():
    ...
    send_lesson,
    pattern=r'^(uz|ru):\d+:\d+:(Dushanba|Seshanba|Chorshanba|Payshanba|Juma|Shanba)$'
    ))
